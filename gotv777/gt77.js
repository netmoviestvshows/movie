  ...
  fetch("https://dapiab.apcqwd.com/api/merge/schedules?lang=1")
    ...
    .then((data) => {
      ...
      matchList.forEach((match) => {
        const homeLogoUrl = match.homeLogoUrl && match.homeLogoUrl.includes("nba.titan007.com")
          ? match.homeLogoUrl.replace(
              "http://nba.titan007.com/",
              "https://cfcdn.apcqwd.com/nbawin007/"
            )
          : match.homeLogoUrl && match.homeLogoUrl.replace(
              "http://zq.win007.com/",
              "https://cfcdn.apcqwd.com/zqwin007/"
            );

        let updatedHomeLogoUrl = homeLogoUrl && homeLogoUrl.includes("cdn.livesports808.com")
          ? homeLogoUrl.replace("https://cdn.livesports808.com/", "https://cfcdn.apcqwd.com/")
          : homeLogoUrl;

        if (homeLogoUrl && homeLogoUrl.includes("http://zq.titan007.com/Image/team/images/") && match.homeId) {
        ...
        const awayLogoUrl = match.awayLogoUrl && match.awayLogoUrl.includes("nba.titan007.com")
          ? match.awayLogoUrl.replace(
              "http://nba.titan007.com/",
              "https://cfcdn.apcqwd.com/nbawin007/"
            )
          : match.awayLogoUrl && match.awayLogoUrl.replace(
              "http://zq.win007.com/",
              "https://cfcdn.apcqwd.com/zqwin007/"
            );

        let updatedAwayLogoUrl = awayLogoUrl && awayLogoUrl.includes("cdn.livesports808.com")
          ? awayLogoUrl.replace("https://cdn.livesports808.com/", "https://cfcdn.apcqwd.com/")
          : awayLogoUrl;

        if (awayLogoUrl && awayLogoUrl.includes("http://zq.titan007.com/Image/team/images/") && match.awayId) {
